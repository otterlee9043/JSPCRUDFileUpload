...
<form action="edituser.jsp" method="post">
    ...
    <div class="col-sm-8">
      <input readonly autofocus class="form-control" name="title" value="<%=u.getTitle()%>">
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-sm-7">
      <input readonly  class="form-control" name="author" value="<%=u.getAuthor()%>" >
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-sm-7">
      <input readonly class="form-control" name="regdate" value="<%=u.getRegdate()%>" >
    </div>
</div>
      <div class="form-group row">
